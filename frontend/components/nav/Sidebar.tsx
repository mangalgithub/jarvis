...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 border-r border-slate-200/50 bg-white/70 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/70">
